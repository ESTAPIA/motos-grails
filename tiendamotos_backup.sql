...
-- Started on 2025-07-07 19:31:07
...
COPY public.artc (artc__id, artcimgn, artcprbs, tpac__id, artcdscr, artcnmbr, artcstock) FROM stdin;
3	https://m.media-amazon.com/images/I/717tJ9XYTGL._UF1000,1000_QL80_.jpg	35.50	2	Guantes de cuero reforzados	Guantes Racing	0
9	https://igmmotos.com/wp-content/uploads/2024/08/igm-cafe-racer-2025-grilla.webp	8000.00	4	Moto new	Moto New Era II	50
4	https://m.media-amazon.com/images/I/71Ue+SEek2L._UY1000_.jpg	200.00	3	Chaqueta impermeable con protecciones	Chaqueta Touring	400
6	https://m.media-amazon.com/images/I/71DjEVs9eKL._UY900_.jpg	100.00	5	Botas de lluvia	Botas para moto	90
8	https://igmmotos.com/wp-content/uploads/2023/03/igm-caballito-125-imagen-main-1.webp	1500.00	4	moto cc175	Moto New Era	90
\.
...
SELECT pg_catalog.setval('public.dtft_dtft__id_seq', 13, true);
...
SELECT pg_catalog.setval('public.dtpd_dtpd__id_seq', 13, true);
...
SELECT pg_catalog.setval('public.fact_fact__id_seq', 10, true);
...
SELECT pg_catalog.setval('public.pedd_pedd__id_seq', 10, true);
...
SELECT pg_catalog.setval('public.sesn_sesn__id_seq', 83, true);
...
-- Completed on 2025-07-07 19:31:10
